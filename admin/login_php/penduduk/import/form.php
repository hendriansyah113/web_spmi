	...
	<body>
		...
		<div style="padding: 0 15px;">
			...
			<a href="index.php" class="btn btn-danger pull-right">
				...
				<a href="http://localhost/coba_kelurahan/login_php/penduduk" button type="submit" name="filter" value="true" class="btn btn-primary">Kembali</button></a><br><br>
			</a>
			...
			if(isset($_POST['preview'])){
				...
				if($ext == "xlsx"){
					...
					foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
						...
						$tanggal_lahir = $row['D']; // Ambil data jenis kelamin
						$jenis_kelamin = $row['E']; // Ambil data jenis kelamin
						$telp = $row['F']; // Ambil data jenis kelamin
						$alamat = $row['G']; // Ambil data jenis kelamin
						$agama = $row['H']; // Ambil data jenis kelamin
						$pekerjaan = $row['I']; // Ambil data jenis kelamin
		

						// Cek jika semua data tidak diisi
						if($id == "" && $nik == "" && $nama == "" && $tanggal_lahir == "" && $jenis_kelamin == "" && $telp == "" && $alamat == "" && $agama == "" && $pekerjaan == "")
						...
						if($numrow > 1){
							...
							$tanggal_lahir_td = ( ! empty($tanggal_lahir))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
							$jenis_kelamin_td = ( ! empty($jenis_kelamin))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
							$telp_td = ( ! empty($telp))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
							...
							$pekerjaan_td = ( ! empty($pekerjaan))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah

							// Jika salah satu data ada yang kosong
							if($id == "" or $nik == "" or $nama == "" or $tanggal_lahir == "" or $jenis_kelamin == "" or $telp == "" or $alamat == "" or $agama == "" or $pekerjaan == ""){
