...
$sql = $pdo->prepare("UPDATE ilkomfitria4 SET nik=:nik, nama=:nama, tanggal_lahir=:tanggal_lahir, jenis_kelamin=:jk, telp=:telp, alamat=:alamat, agama=:agama, pekerjaan=:pekerjaan WHERE id=:id");
...
$sql = $pdo->prepare("SELECT foto FROM ilkomfitria4 WHERE id=:id");
$sql->bindParam(':id', $id);
...
// Proses ubah data ke Database
$sql = $pdo->prepare("UPDATE ilkomfitria4 SET nik=:nik, nama=:nama, tanggal_lahir=:tanggal_lahir, jenis_kelamin=:jk, telp=:telp, alamat=:alamat, agama=:agama, pekerjaan=:pekerjaan, foto=:foto WHERE id=:id");
$sql->bindParam(':nik', $nik);
$sql->bindParam(':nama', $nama);
$sql->bindParam(':tanggal_lahir', $tanggal_lahir);
$sql->bindParam(':jk', $jenis_kelamin);
