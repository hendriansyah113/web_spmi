...
<html lang="en">
    <head>
        ...
        <title>Import Data Kelahiran Excel dengan PHP</title>
    ...
    <body>
        ...
        <div style="padding: 0 15px;">
            ...
            <a href="index.php" class="btn btn-danger pull-right">
                ...
                <a href="http://localhost/coba_kelurahan/login_php/search_pagination/index.php" button type="submit" name="filter" value="true" class="btn btn-primary">Kembali</button></a><br><br>
            </a>

            <h3>Form Import Data Kelahiran</h3>
            <hr>
            ...
            if(isset($_POST['preview'])){
                ...
                if($ext == "xlsx"){
                    ...
                    foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                        ...
                        $jumlah_kelahiran = $row['C']; // Ambil data 
                        ...
                        if($numrow > 1){
                            ...
                            $tanggal_lahir_td = ( ! empty($tanggal_lahir))? "" : " style='background: #E07171;'"; // Jika Nama kosong, beri warna merah
                            $jumlah_kelahiran_td = ( ! empty($jumlah_kelahiran))? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah

                            // Jika salah satu data ada yang kosong
                            if($id == "" or $tanggal_lahir == "" or $jumlah_kelahiran == ""){
                            ...
                            echo "<td".$jumlah_kelahiran_td.">".$jumlah_kelahiran."</td>";
                            echo "</tr>";
                        }
