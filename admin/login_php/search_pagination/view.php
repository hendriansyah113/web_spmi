<div class="table-responsive">
    <table class="table table-bordered">
        <tr>
            ...
            <a href="multiple_insert_kelahiran" class="btn btn-success">Tambah Data Kelahiran</a>
                <a href="pdf_kelahiran" class="btn btn-primary">Cetak PDF</a>
                <a href="import" class="btn btn-primary">Import</a>
                <a href="export/index_export.php" class="btn btn-primary">Export</a>
                <br><br>
            </td>
        </tr>
        <tr>
